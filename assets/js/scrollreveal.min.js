...
var ScrollReveal = (function () {
  ...
  function i(e, a, t) {
    ...
    try {
      ...
      f(
        i.reduce(function (e, t) {
          ...
          var o,
            s = u(r.contenedor)[0];
          if (!s) throw new Error("Invalid contenedor.");
          return (
            s.contains(t) &&
              (null ===
                (o = (function (t) {
    ...
    f(d, function (e) {
      c.store.contenedors[e.id] = { id: e.id, node: e.node };
    }),
  ...
  function q(e, t) {
    ...
    void 0 === e && (e = { type: "init" }),
      ...
      x(function () {
        ...
        f(i.store.contenedors, function (e) {
          ...
          f(t, function (e) {
            (n || void 0 === e.geometry) && (e.geometry = R.call(i, e)),
              (e.visible = function (e) {
                void 0 === e && (e = {});
                var t = this.store.contenedors[e.contenedorId];
                if (t) {
  ...
  function H(e) {
    ...
    try {
      if (!u(t.contenedor)[0]) throw new Error("Invalid contenedor.");
    } catch (e) {
